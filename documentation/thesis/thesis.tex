...
TODO
Measuring the performance of a model $\boldsymbol{y}$ is an important task. Choosing a proper performance measure is highly task dependent. For this thesis the mean absolute error (MAE) and the accuracy were determined to be suited.
