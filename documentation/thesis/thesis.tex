...
Bertero et al. apply LSTMs on the same dataset of Big Bang Theory dialogue as in their previous work. \cite{Bertero2016DeepLO} Instead of a simple RNN they use a more sophisticated LSTM architecture.
