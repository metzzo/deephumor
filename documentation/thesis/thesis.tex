...
And then continuing in 2016 with AlphaGo winning against one of the best human player of the board game Go \cite{alphago}. Compared to chess Go is a much more difficult game to play for computers, as the combinatorial explosion is much larger and the heuristics available are much weaker in Go compared to chess \cite{alphago}.
