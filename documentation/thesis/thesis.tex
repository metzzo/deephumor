...
Combining these transformations together for a simple two layer network results in the following equation:
...
This naive approach has problems, which can be mitigated by different measures:
...
Obtaining the gradient is also a computationally complicated step. The usual forward derivation method commonly learned in school does not scale well to many parameters. Therefore a technique called backpropagation is commonly used. [TODO]
