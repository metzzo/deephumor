...
class ResNetClassificationModel(BaseModel):
    class Network(nn.Module):
        def __init__(self):
            super(ResNetClassificationModel.Network, self).__init__()
    ...
    def get_network_class(self):
        return ResNetClassificationModel.Network
    ...
    def train_evaluations(self):
        return super(ResNetClassificationModel, self).train_evaluations + [AccuracyEvaluation]

    @property
    def validation_evaluations(self):
        return super(ResNetClassificationModel, self).validation_evaluations + [AccuracyEvaluation] + [partial(DetailedEvaluation, model=self)]
